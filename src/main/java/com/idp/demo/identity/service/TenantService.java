...
public class TenantService {
    ...
    @Autowired
    public void TenantService(GoogleCredentials googleCredentials,
    ...
    public TenantResponse createTenant(CreateTenantRequest createTenantRequest) {
        ...
        ResponseEntity<TenantResponse> response = restTemplate.postForEntity(
                tenantURI, request, TenantResponse.class);
    ...
    public TenantListResponse listTenants() {
        String token = getToken();
        HttpHeaders headers = createAuthHeaders(token);
        ResponseEntity<TenantListResponse> response = restTemplate.exchange(
    ...
    public CreateUserResponse createTenantUser(String projectId, String tenantId,
        ...
        String url = "https://identitytoolkit.googleapis.com/v1/projects/" + projectId +
