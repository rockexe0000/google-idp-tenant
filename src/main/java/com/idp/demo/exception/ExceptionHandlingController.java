package com.idp.demo.exception;
...
public class ExceptionHandlingController {
  ...
  public ResponseEntity<GeneralResponse> identityFail(IdentityOperationException ex) {
    GeneralResponse response =
        new GeneralResponse(HttpStatus.INTERNAL_SERVER_ERROR.value(), ex.getMessage());
  ...
  public ResponseEntity<GeneralResponse> illegalState(IllegalArgumentException ex) {
    GeneralResponse response = new GeneralResponse(HttpStatus.BAD_REQUEST.value(), ex.getMessage());
